...
class IntIntDictTest(unittest.TestCase):
    ...
    # -- sentinel key (-999999999) handling tests --

    def test_sentinel_key_as_value(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(1), int32(-999999999))
        self.assertEqual(-999999999, xs_int_int_dict_get(xs_dct, int32(1)))
        self.assertEqual(1, xs_int_int_dict_size(xs_dct))

    def test_sentinel_key_cannot_be_stored_as_key(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(-999999999), int32(42))
        self.assertFalse(xs_int_int_dict_contains(xs_dct, int32(-999999999)))
        self.assertEqual(0, xs_int_int_dict_size(xs_dct))

    def test_sentinel_key_get_returns_default(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(1), int32(10))
        result = xs_int_int_dict_get(xs_dct, int32(-999999999), int32(77))
        self.assertEqual(77, result)
        self.assertEqual(c_int_int_dict_no_key_error, xs_int_int_dict_last_error())

    def test_sentinel_key_remove_returns_error(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(1), int32(10))
        result = xs_int_int_dict_remove(xs_dct, int32(-999999999))
        self.assertEqual(c_int_int_dict_no_key_error, xs_int_int_dict_last_error())
        self.assertEqual(1, xs_int_int_dict_size(xs_dct))

    def test_sentinel_key_not_in_contains(self):
        xs_dct = xs_int_int_dict_create()
        self.assertFalse(xs_int_int_dict_contains(xs_dct, int32(-999999999)))

    def test_sentinel_value_survives_rehash(self):
        xs_dct = xs_int_int_dict_create()
        for k in range(50):
            xs_int_int_dict_put(xs_dct, int32(k), int32(-999999999))
        for k in range(50):
            self.assertEqual(-999999999, xs_int_int_dict_get(xs_dct, int32(k)))
        self.assertEqual(50, xs_int_int_dict_size(xs_dct))

    def test_sentinel_value_in_copy(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(5), int32(-999999999))
        copy = xs_int_int_dict_copy(xs_dct)
        self.assertEqual(-999999999, xs_int_int_dict_get(copy, int32(5)))

    def test_sentinel_value_in_iteration(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(1), int32(-999999999))
        xs_int_int_dict_put(xs_dct, int32(2), int32(-999999999))
        result = self._iter_dict(xs_dct)
        self.assertEqual({1: -999999999, 2: -999999999}, result)

    def test_sentinel_value_in_keys_and_values(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(10), int32(-999999999))
        keys_arr = xs_int_int_dict_keys(xs_dct)
        vals_arr = xs_int_int_dict_values(xs_dct)
        self.assertEqual(10, xs_array_get_int(keys_arr, 0))
        self.assertEqual(-999999999, xs_array_get_int(vals_arr, 0))

    def test_sentinel_value_in_to_string(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put(xs_dct, int32(1), int32(-999999999))
        s = xs_int_int_dict_to_string(xs_dct)
        self.assertIn("1: -999999999", s)

    def test_sentinel_value_in_equals(self):
        a = xs_int_int_dict_create()
        b = xs_int_int_dict_create()
        xs_int_int_dict_put(a, int32(1), int32(-999999999))
        xs_int_int_dict_put(b, int32(1), int32(-999999999))
        self.assertTrue(xs_int_int_dict_equals(a, b))

    def test_sentinel_value_in_update(self):
        src = xs_int_int_dict_create()
        other = xs_int_int_dict_create()
        xs_int_int_dict_put(other, int32(3), int32(-999999999))
        xs_int_int_dict_update(src, other)
        self.assertEqual(-999999999, xs_int_int_dict_get(src, int32(3)))

    def test_sentinel_value_in_put_if_absent(self):
        xs_dct = xs_int_int_dict_create()
        xs_int_int_dict_put_if_absent(xs_dct, int32(7), int32(-999999999))
        self.assertEqual(-999999999, xs_int_int_dict_get(xs_dct, int32(7)))
        xs_int_int_dict_put_if_absent(xs_dct, int32(7), int32(99))
        self.assertEqual(-999999999, xs_int_int_dict_get(xs_dct, int32(7)))

    def test_xs_int_int_dict_constructor_skips_sentinel_key(self):
        xs_dct = xs_int_int_dict(int32(1), int32(10), int32(-999999999), int32(20))
        self.assertEqual(1, xs_int_int_dict_size(xs_dct))
        self.assertEqual(10, xs_int_int_dict_get(xs_dct, int32(1)))
