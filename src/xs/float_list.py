...
def _xs_float_list_set_size(lst: int32 = int32(-1), size: int32 = int32(0)) -> None:
    xs_array_set_float(lst, 0, bit_cast_to_float(size))


def xs_float_list_create(capacity: int32 = int32(7)) -> int32:
    """
    ...
    lst: int32 = xs_array_create_float(capacity + 1)
    if lst < 0:
        return c_float_list_generic_error
...
def xs_float_list(
        v0: float32 = c_float_list_empty_param,
        v1: float32 = c_float_list_empty_param,
        v2: float32 = c_float_list_empty_param,
        v3: float32 = c_float_list_empty_param,
        v4: float32 = c_float_list_empty_param,
        v5: float32 = c_float_list_empty_param,
        v6: float32 = c_float_list_empty_param,
        v7: float32 = c_float_list_empty_param,
        v8: float32 = c_float_list_empty_param,
        v9: float32 = c_float_list_empty_param,
        v10: float32 = c_float_list_empty_param,
    ...
    if lst < 0:
        return c_float_list_generic_error
    if v0 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(0))
        return lst
    xs_array_set_float(lst, 1, v0)
    if v1 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(1))
        return lst
    xs_array_set_float(lst, 2, v1)
    if v2 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(2))
        return lst
    xs_array_set_float(lst, 3, v2)
    if v3 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(3))
        return lst
    xs_array_set_float(lst, 4, v3)
    if v4 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(4))
        return lst
    xs_array_set_float(lst, 5, v4)
    if v5 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(5))
        return lst
    xs_array_set_float(lst, 6, v5)
    if v6 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(6))
        return lst
    xs_array_set_float(lst, 7, v6)
    if v7 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(7))
        return lst
    xs_array_set_float(lst, 8, v7)
    if v8 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(8))
        return lst
    xs_array_set_float(lst, 9, v8)
    if v9 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(9))
        return lst
    xs_array_set_float(lst, 10, v9)
    if v10 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(10))
        return lst
    xs_array_set_float(lst, 11, v10)
    if v11 == c_float_list_empty_param:
        _xs_float_list_set_size(lst, int32(11))
        return lst
    xs_array_set_float(lst, 12, v11)
    _xs_float_list_set_size(lst, int32(12))
    return lst
...
def xs_float_list_from_repeated_val(value: float32 = float32(0.0), times: int32 = int32(0)) -> int32:
    ...
    if lst < 0:
        return c_float_list_generic_error
    _xs_float_list_set_size(lst, times)
    return lst
...
def xs_float_list_from_repeated_list(lst: int32 = int32(-1), times: int32 = int32(0)) -> int32:
    ...
    if new_capacity > c_float_list_max_capacity:
        return c_float_list_generic_error
    new_lst: int32 = xs_array_create_float(new_capacity)
    if new_lst < 0:
        return c_float_list_generic_error
    for i in i32range(1, size + 1):
        val: float32 = xs_array_get_float(lst, i)
        j: int32 = i
        while j < new_capacity:
            xs_array_set_float(new_lst, j, val)
            j += size
    _xs_float_list_set_size(new_lst, new_capacity - 1)
    return new_lst
...
def xs_float_list_from_array(arr: int32 = int32(-1)) -> int32:
    ...
    for i in i32range(0, arr_size):
        xs_array_set_float(lst, i + 1, xs_array_get_float(arr, i))
    _xs_float_list_set_size(lst, arr_size)
    return lst
...
def xs_float_list_use_array_as_source(arr: int32 = int32(-1)) -> int32:
    ...
    r: int32 = xs_array_resize_float(arr, arr_size + 1)
    if r < 0:
...
def _xs_float_list_extend_int_array(lst: int32 = int32(-1), capacity: int32 = int32(0)) -> int32:
...
def xs_float_list_append(lst: int32 = int32(-1), value: float32 = float32(0)) -> int32:
    ...
    if capacity == next_idx:
        r: int32 = _xs_float_list_extend_int_array(lst, capacity)
        if r != c_float_list_success:
            return r
    xs_array_set_float(lst, next_idx, value)
    _xs_float_list_set_size(lst, next_idx)
    return c_float_list_success
...
def xs_float_list_insert(lst: int32 = int32(-1), idx: int32 = int32(-1), value: float32 = float32(0)) -> int32:
    ...
    xs_array_set_float(lst, idx + 1, value)
    _xs_float_list_set_size(lst, new_size)
...
def _xs_float_list_compare_elem(a: float32 = float32(-1.0), b: float32 = float32(-1.0), reverse: bool = False) -> bool:
    if reverse:
        return a > b
    return a < b


def _xs_float_list_sift_down(lst: int32 = int32(-1), start: int32 = int32(-1), end: int32 = int32(-1), reverse: bool = False) -> None:
    root: int32 = start
    while True:
        child: int32 = 2 * root
        if child > end:
...
def xs_float_list_sort(lst: int32 = int32(-1), reverse: bool = False) -> None:
    ...
    for end in i32range(size, 1, -1):
        ...
        _xs_float_list_sift_down(lst, int32(1), end - 1, reverse)
...
def xs_float_list_extend(source: int32 = int32(-1), lst: int32 = int32(-1)) -> int32:
    ...
    _xs_float_list_set_size(source, new_size)
    return c_float_list_success
...
def float_list(include_test: bool) -> tuple[str, str]:
    ...
    xs = constants_xs + PythonToXsConverter.to_xs_script(
        ...
        xs_float_list_get,
        xs_float_list_set,
        _xs_float_list_extend_int_array,
        _xs_float_list_shrink_int_array,
