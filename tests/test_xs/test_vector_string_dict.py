...
from xs_converter.functions import vector, xs_array_create_int, xs_array_get_int, xs_array_get_size, \
    xs_array_get_vector, xs_array_get_string, xs_array_resize_int, xs_array_set_int
...
class VectorStringDictNativeTest(unittest.TestCase):
    ...
    def test_keys_returns_resize_error_for_wrong_type_output_array(self):
        ...
        _vsd.xs_vector_string_dict_put(xs_dct, vector(4.0, 5.0, 6.0), "two")
        out_arr = xs_array_create_int(int32(2), int32(-7))

        arr = _vsd.xs_vector_string_dict_keys(xs_dct, out_arr)

        self.assertEqual(_vsd.c_vector_string_dict_resize_failed_error, arr)
