...
def xs_float_vector_dict_keys(dct: int32 = int32(-1), out_arr: int32 = int32(-1)) -> int32:
    """
...
def xs_float_vector_dict_values(dct: int32 = int32(-1), out_arr: int32 = int32(-1)) -> int32:
    """
    ...
    for i in i32range(1, capacity, 4):
        stored_key: float32 = _xs_float_vector_dict_get_stored_key(dct, i)
        if stored_key != c_float_vector_dict_empty_key:
            r: int32 = xs_array_set_vector(arr, idx, _xs_float_vector_dict_get_stored_value(dct, i))
            if r != 1:
                return c_float_vector_dict_resize_failed_error
            idx += 1
    return arr
